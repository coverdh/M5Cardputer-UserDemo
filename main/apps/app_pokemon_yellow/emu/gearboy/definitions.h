...
#define GEARBOY_DISABLE_COLOR_CORRECTION
#define GEARBOY_ESP32_NO_SGB
#define GEARBOY_ESP32_NO_SGB_BUFFER
#define GEARBOY_ESP32_NO_AUDIO_DEBUG
#define GEARBOY_DISABLE_VGMRECORDER
#define PERFORMANCE
