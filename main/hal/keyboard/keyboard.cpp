...
const KeyValue_t _key_value_map[4][14] = {
    ...
    {{"`",     KEY_GRAVE,      "~",     KEY_GRAVE,      "esc",   KEY_ESC,       0              },
     {"1",     KEY_1,          "!",     KEY_1,          "F1",    KEY_F1,        0              },
     {"2",     KEY_2,          "@",     KEY_2,          "F2",    KEY_F2,        0              },
     {"3",     KEY_3,          "#",     KEY_3,          "F3",    KEY_F3,        0              },
     {"4",     KEY_4,          "$",     KEY_4,          "F4",    KEY_F4,        0              },
     {"5",     KEY_5,          "%",     KEY_5,          "F5",    KEY_F5,        0              },
     {"6",     KEY_6,          "^",     KEY_6,          "F6",    KEY_F6,        0              },
     {"7",     KEY_7,          "&",     KEY_7,          "F7",    KEY_F7,        0              },
     {"8",     KEY_8,          "*",     KEY_8,          "F8",    KEY_F8,        0              },
     {"9",     KEY_9,          "(",     KEY_9,          "F9",    KEY_F9,        0              },
     {"0",     KEY_0,          ")",     KEY_0,          "F10",   KEY_F10,       0              },
